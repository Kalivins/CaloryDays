...
class PostRecipe extends Bdd
{
    ...
    public function getRecipe($recipeId)
    {
        ...
        $req = $pdo->prepare('SELECT user.pseudo, user.email, food.id, food.product_name, recette.preparation, recette.nom_recette, recette.photo FROM recette, user, food INNER JOIN user_recette WHERE user_recette.id_recette = :id INNER JOIN recette_food WHERE recette_food.id_recette = :id');
